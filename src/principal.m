  % -*- octave -*-
  % This script receives the the script URL to analyze.
  % It defines variables and constant values that will be used during execution.
  % It returns the final information of the analyzed activities, the defined states, and the video name.
